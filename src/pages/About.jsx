    ...
    <div className="min-h-screen bg-white flex items-center justify-center p-10">
      <div className="container mx-auto flex flex-col md:flex-row items-center justify-between gap-12">
        ...
        <div className="md:w-1/3 flex flex-col items-center justify-center text-center space-y-4">
          <div>
            <p className="text-sm font-bold text-gray-500 text-left mb-2">
              Nice to meet you!
            </p>
        ...
        <div className="md:w-2/3 flex flex-col space-y-8">
          ...
          <div className="flex flex-col md:flex-row gap-12">
            <div className="flex-1 space-y-3">
              ...
              <p className="text-sm text-gray-700">
                Dedicated frontend developer crafting thoughtful digital
                experiences with a decade of hands-on design-to-code delivery.
              </p>
            </div>
            <div className="flex-1 space-y-3">
              <div className="flex items-center gap-4">
              ...
              <p className="text-sm text-gray-700">
                Partnered with teams across the globe to launch products that
                balance usability, performance, and visual polish.
              </p>
            </div>
          </div>
          ...
          <div className="bg-black text-white p-8 relative rounded-sm shadow-xl">
            <span className="text-6xl absolute top-4 left-4 opacity-20 font-serif">
              “
            </span>
