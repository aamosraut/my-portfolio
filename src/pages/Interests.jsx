...
const Interests = () => {
  const interests = [
    ...
    },
    {
      ...
      title: "Cybersecurity",
      description:
        "Passionate about digital security, ethical hacking, and protecting systems from vulnerabilities.",
    },
    {
      icon: <Code size={32} />,
      title: "Coding",
      description:
        "Love solving problems through code, building web applications, and exploring new technologies.",
    },
  ];
  ...
  const hobbies = [
    {
      ...
      description:
        "Enjoy the thrill of the game, teamwork, and the competitive spirit on the field.",
    },
    {
      icon: <Music size={32} />,
      title: "Listening to Music",
      description:
        "Music fuels my creativity and keeps me motivated throughout my coding sessions.",
    },
    {
      icon: <Heart size={32} />,
      title: "Learning New Things",
      description:
        "Always curious about new technologies, tools, and skills to expand my knowledge.",
    },
  ];
    ...
    <div className="min-h-screen bg-white flex items-center justify-center p-10">
      <div className="container mx-auto">
        ...
        <div className="text-center mb-12">
          <p className="text-sm font-bold text-gray-500 tracking-widest mb-2">
            What drives me
          </p>
          <h1 className="text-5xl font-black text-black mb-4">MY INTERESTS</h1>
          <p className="text-gray-700 max-w-2xl mx-auto">
            A glimpse into what I'm passionate about and what keeps me inspired
            outside of work.
          </p>
        </div>
        ...
        <div className="mb-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {interests.map((interest, index) => (
              ...
              >
                <div className="text-neutral-900 mb-4">{interest.icon}</div>
        ...
        <div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {hobbies.map((hobby, index) => (
              ...
              >
                <div className="text-gray-400 mb-4">{hobby.icon}</div>
