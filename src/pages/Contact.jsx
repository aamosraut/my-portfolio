      ...
      <div className="container mx-auto flex flex-col md:flex-row gap-12">
        ...
        <div className="md:w-2/5 flex flex-col justify-start space-y-8">
          <div>
            ...
            <p>
              I am available for new projects and collaborations. Tell me the
              basics and i will get back with a tailored plan.
            </p>
          </div>
          ...
          <form className="space-y-6" onSubmit={onSubmit}>
            ...
            <div>
              ...
              <p className="text-xs text-gray-500 mt-2">
                Be concise helps us respond faster. We respect your privacy and
                wont share your information.
              </p>
            </div>
